<?php $meta = liv_theme_entry_meta(); ?>
	...
	<?php
		...
		$post_thumb = wp_get_attachment_image_src($thumb_id, 'post-thumbnail');

		if( $post_thumb ) : 
	?>
		<div class="post-thumbnail-container" style="background-image: url(<?php echo $post_thumb[0]; ?>); height: <?php echo $post_thumb[2]; ?>px;"></div>
	<?php endif; ?>
